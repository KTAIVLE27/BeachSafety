...
| [박세리](https://github.com/kong68)    | $\cdot$ Backend <br/> $\cdot$ DB설계, 게시판 CRUD, AWS 서버 구축, 이안류 API 연동 및 시각화, 개인정보 마스킹, 회원가입 조건 검증 <br/> $\cdot$ Yolov8 실시간 CCTV 인원 수 비동기 실시간 업데이트 <br/> $\cdot$ open AI GPT-3.5 -turbo 생성형 AI를 활용한 챗봇으로 모의훈련 시나리오 생성                                                                                             |
